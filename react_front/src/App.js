...
// 확장하여 App.js에서 여러가지 page들을 메뉴로 관리 하기 위해
function App() {
  return (
...
/*
  ...
  만약 nav의 메뉴를 클릭하면 다른부분은 전혀 변경(새로고침, Reloading)이 되지 않으면서
  Rroute로 설정된 부분만 새로 고침이 되는 구조가 된다.

  a hrefㄹ 구성된 메뉴를 클릭하면 일부만 변경이 이루어지더라도 
  화면전체가 새로 고침이 일어나는데
